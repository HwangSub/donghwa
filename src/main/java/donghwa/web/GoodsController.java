...
public class GoodsController {
	...
	public static String dirPath = "C:/eGovFrameDev-4.2.0-64bit/workspace/donghwa2/src/main/webapp/upload";
	...
	public String insertGoods(   MultipartHttpServletRequest multiRequest
		...
		// multiRequest 가 저장 후 정보들을 보관함(암호화이름,리얼이름,크기,종류) 
		...
		if( itr.hasNext() ) { // 참(true)
			...
			System.out.println( file.getContentType() ); // 파일 종류
		
			// 1024byte  == 1kByte
			// 1024kbyte == 1MByte
			// 1024Mbyte == 1GByte
			int filesize = (int)file.getSize();
			int maxsize  = 1024 * 1024 * 5; // 5메가로 제한을 두기위한 설정
	...
	@ResponseBody
	public String updateGoods(MultipartHttpServletRequest multiRequest
							 ,GoodsVO vo)  throws Exception {
		String msg = "ok";
	...
	@RequestMapping(value="/admGoodsList.do")
