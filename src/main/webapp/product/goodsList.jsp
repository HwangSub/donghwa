        ...
        <section class="sub">
            <div class="navi2 sub_center">
                ...
                <ul class="tab_menu">
                    ...
                    <li>
                        <a href="javascript:fn_location(1)">신제품</a> 
                    </li>
                    <li>
                    	<a href="javascript:fn_location(2)">전문의약품</a> 
                    </li>
                    <li>
                    	<a href="javascript:fn_location(3)">일반의약품</a> 
                    </li>
                    <li>
                    	<a href="javascript:fn_location(4)">건강기능식품</a> 
                    </li>
                </ul>
            </div>
            <div class="content">
                            ...
                            <div class="search">
                                <div class="search_inner">
                                    <form data-aos="fade-down" data-aos-duration="1000" data-aos-delay="300"
                                    	  id="searchForm" method="post" action="/goodsList.do">
                                        <div class="form_inner">
                                      		<input type="hidden" name="cate" id="cate" value="1">
                                    		<input type="hidden" name="pageIndex" id="pageIndex" value="1">
                                            <input type="text" name="searchText" placeholder="제품명, 성분명 등을 입력해주세요.">
                                            <button type="submit" id="btnSave"></button>
                                        </div>
                                    </form>
                                </div>
                                <div class="keyword">
                            ...
                            <div class="product_list" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="300">
                                ...
                                <div class="pro_wrap">
                                   ...
                                   <c:forEach var="goods" items="${list }">
                                        <li>
                                            <a href="#none"><img src="upload/${goods.FILENAME }" alt="후시딘"></a>
								...
								<c:forEach var="p" begin="1" end="${totalpage}">
										<li>
											<a href="javascript:fn_page('${p}')">${p }</a>
										</li>
								</c:forEach>
