...
$(function(){
	...
	$("#btnSave").click(function(){ 
		...
		//map.put("title", "12121");
		//map.put("userid", "test121212");
		%>

		//let sss="title="+title+"&userid="+userid+"&cont"+cont;
	...
	<br>
		...
		<table class="type08" align="center">	
			...
			<tr>
				<th>일정날짜</th>
				<td>
					<input type="text" name="schdt1" id="schdt1" 
													style="width:235px;margin-bottom:3px;">
					<br>
					<select name="schdt2" id="schdt2">
				<%
